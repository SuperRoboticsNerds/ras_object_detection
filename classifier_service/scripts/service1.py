...
def decisionRules1(counts):
	...
	if counts[0] > 300 and counts[0] < 1000:
		counts[0] = counts[0] - 300
	...
	if maxVote  < 100 or counts[0] < 180:
		# return "something"
		return 99
...
if __name__ == '__main__':
	...
	clf1 = pickle.load(open("svm_classifier_rbf_real1_7.p", "rb"))
	clf2 = pickle.load(open("svm_classifier_linear.p","rb"))
	# clf = pickle.load(open("svm_classifier_linear.p","rb"))
